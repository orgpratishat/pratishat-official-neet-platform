...
//       for (let j = 0; j < question.options.length; j++) {
//         const option = question.options[j];
//         const optionPlainText = option.text.replace(/<[^>]*>/g, '').trim();
//         if (!optionPlainText) {
//           alert(`Please enter text for Option ${j + 1} in Question ${i + 1}`);
//           return false;
//         }
...
//                                 <div className="flex-1">
//                                   <label className="block text-xs font-medium text-gray-700 mb-1">
//                                     Option {oIndex + 1} Text *
//                                   </label>
//                                   <RichTextEditor
//                                     value={option.text}
//                                     onChange={(value) => handleOptionChange(qIndex, oIndex, 'text', value)}
...
//                             <RichTextEditor
//                               value={question.hint}
//                               onChange={(value) => handleQuestionChange(qIndex, 'hint', value)}
//                               placeholder="Provide a hint for the question (optional)"
//                             />
//                           </div>
//                           <div>
...
//                             <RichTextEditor
//                               value={question.approach}
//                               onChange={(value) => handleQuestionChange(qIndex, 'approach', value)}
//                               placeholder="Describe the approach to solve this question (optional)"
//                             />
//                           </div>
//                           <div>
...
//                                       handleQuestionChange(qIndex, 'steps', updatedSteps);
//                                     }}
//                                     className="text-red-600 hover:text-red-800 flex-shrink-0 self-start mt-2"
//                                   >
//                                     Remove
//                                   </button>
//                                 )}
...
function AdminPanel() {
  ...
  // Validate form before submission - Updated to handle formatted text
  const validateForm = () => {
    if (!formData.title.trim()) {
      alert('Please enter a test title');
      return false;
    ...
    for (let i = 0; i < formData.questions.length; i++) {
      ...
      // Remove formatting markers for validation
      ...
      for (let j = 0; j < question.options.length; j++) {
        const option = question.options[j];
        const optionPlainText = option.text
          .replace(/\*\*/g, '')
          .replace(/\*/g, '')
          .replace(/__/g, '')
          .replace(/~/g, '')
